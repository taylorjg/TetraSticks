...
namespace TetraSticks.View
{
    public partial class BoardControl : IBoardControl
    {
        ...
        private void AddAppropriateLine(PathSegmentCollection segments, Tuple<Coords, Coords, Direction> lineSegment)
        {
            ...
            {
                case Direction.Left:
                    AddLineHorizontal(segments, lineSegment.Item2, lineSegment.Item1);
                    break;
                case Direction.Right:
                    AddLineHorizontal(segments, lineSegment.Item1, lineSegment.Item2);
                    break;
                case Direction.Up:
                    AddLineVertical(segments, lineSegment.Item1, lineSegment.Item2);
                    break;
                case Direction.Down:
                    AddLineVertical(segments, lineSegment.Item2, lineSegment.Item1);
                    break;
                default:
                    throw new InvalidOperationException("...");
            }
